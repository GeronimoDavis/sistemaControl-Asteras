...
import { getAllGastos, getGastoByid, createGasto, updateGastos, getCategoriasGastos } from "../api";
                        ...
                        <tbody>
                            {gastos.map((g) => (
                                <tr key={g._id}>
                                    ...
                                    <td><button onClick={() => handleEdit(g)} className="btn-editar">Editar</button></td>
                                </tr>
                            ))}
                        </tbody>
                </table>
